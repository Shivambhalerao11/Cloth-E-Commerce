        ...
        <div className="bg-[#fff9ed] p-6 sm:p-10 xl:p-12 flex flex-col">
          ...
          <div className="flex flex-col sm:flex-row gap-3 mb-5">
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 border border-[#cfc5bd] bg-[#f9f3e7] hover:border-[#1d1c14] hover:bg-[#f3ede1] transition-colors py-3 px-3 font-mono-custom text-xs uppercase tracking-wide disabled:opacity-50 cursor-pointer"
            >
